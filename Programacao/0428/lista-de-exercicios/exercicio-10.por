programa
{
	...
	funcao inicio()
	{
		...
		real percentual_alunos_media_5, qtd_alunos=0.0, qtd_alunos_media_5=0.0
		...
		para (inteiro cont=0; cont < 2; cont++) {
			...
			se (media_notas_aluno >= 5) {
				qtd_alunos_media_5 += 1
			}
			
		}

		media_notas = soma_notas / (qtd_alunos * 3)
		percentual_alunos_media_5 = (qtd_alunos_media_5 * 100) / qtd_alunos

		escreva("Média da turma: ", media_notas, "\n")
		escreva("Percentual de alunos com média 5: ", percentual_alunos_media_5, "%\n")
	}
}
/* $$$ Portugol Studio $$$ 
 * 
